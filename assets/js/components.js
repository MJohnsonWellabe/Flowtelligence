/* components.js — Lowtech subpage nav + footer
...
'    --aqua-pale:#E6F9FC!important; --gold:#FFC220; --gold-lt:#FFD84D;',
'  }',
'  #site-nav {',
'    position:fixed;top:0;left:0;right:0;height:68px;',
'    background:#0B1C2C;z-index:1000;',
'    display:flex;align-items:center;padding:0 1.75rem;gap:.75rem;',
'    box-shadow:0 2px 16px rgba(0,0,0,.3);border-bottom:2px solid #FFC220;',
'  }',
...
'  .nav-brand .brand-a{color:#FFC220;}',
...
'  /* CTA */',
'  .nav-cta-btn{padding:.42rem 1.1rem;background:#FFC220;color:#0B1C2C!important;font-weight:700;border-radius:6px;margin-left:.25rem;white-space:nowrap;font-family:"DM Sans",system-ui,sans-serif;font-size:.86rem;text-decoration:none;transition:background .18s;flex-shrink:0;}',
...
'  .sb-link:hover,.sb-toggle:hover{background:rgba(255, 194, 32,.1);color:#FFC220;border-left-color:#FFC220;}',
'  .sb-link.active{color:#FFC220;border-left-color:#FFC220;background:rgba(255, 194, 32,.08);}',
...
'  .sb-sub li a:hover{color:#FFC220;}',
'  .sb-sub li a.sb-indent{padding-left:3rem;font-size:.8rem;opacity:.75;}',
'  .sb-sub li a.sb-indent:hover{opacity:1;color:#FFC220;}',
...
'        <a href="../pages/tools.html?tab=engage">Engage</a>',
...
'        <a class="dd-sub" href="../pages/messaging.html">&#8627; Link</a>',
'        <a class="dd-sub" href="../pages/incentives.html">&#8627; Spark</a>',
'        <a class="dd-sub" href="../pages/app-scanning.html">&#8627; ScanIQ</a>',
'        <a class="dd-sub" href="../pages/lead-gen.html">&#8627; LeadFlow</a>',
'        <a href="../pages/tools.html?tab=launchpad">Launchpad</a>',
'      </div>',
'    </li>',
'    <li id="tl-c">',
...
'        <li><a href="../pages/tools.html?tab=engage">Engage</a></li>',
...
'        <li><a class="sb-indent" href="../pages/messaging.html">&#8627; Link</a></li>',
'        <li><a class="sb-indent" href="../pages/incentives.html">&#8627; Spark</a></li>',
'        <li><a class="sb-indent" href="../pages/app-scanning.html">&#8627; ScanIQ</a></li>',
'        <li><a class="sb-indent" href="../pages/lead-gen.html">&#8627; LeadFlow</a></li>',
'        <li><a href="../pages/tools.html?tab=launchpad">Launchpad</a></li>',
'      </ul>',
'    </li>',
'    <li>',
...
'    <li><a class="sb-link" href="../pages/contact.html" style="color:#FFC220;font-weight:700;">Contact Us</a></li>',
'  </ul>',
'</div>',
