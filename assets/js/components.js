/* components.js — Flowtelligence subpage nav + footer
...
'    --aqua-pale:#E6F9FC!important; --gold:#F2C300; --gold-lt:#FFD84D;',
'  }',
'  #site-nav {',
'    position:fixed;top:0;left:0;right:0;height:68px;',
'    background:#0B1C2C;z-index:1000;',
'    display:flex;align-items:center;padding:0 1.75rem;gap:.75rem;',
'    box-shadow:0 2px 16px rgba(0,0,0,.3);border-bottom:2px solid #F2C300;',
'  }',
...
'  .nav-brand .brand-a{color:#F2C300;}',
...
'  /* CTA */',
'  .nav-cta-btn{padding:.42rem 1.1rem;background:#F2C300;color:#0B1C2C!important;font-weight:700;border-radius:6px;margin-left:.25rem;white-space:nowrap;font-family:"DM Sans",system-ui,sans-serif;font-size:.86rem;text-decoration:none;transition:background .18s;flex-shrink:0;}',
'  .nav-cta-btn:hover{background:#FFD84D;}',
'  /* Hamburger */',
...
'  .sb-link:hover,.sb-toggle:hover{background:rgba(242,195,0,.1);color:#F2C300;border-left-color:#F2C300;}',
'  .sb-link.active{color:#F2C300;border-left-color:#F2C300;background:rgba(242,195,0,.08);}',
...
'  .sb-sub li a:hover{color:#F2C300;}',
'  .sb-sub li a.sb-indent{padding-left:3rem;font-size:.8rem;opacity:.75;}',
'  .sb-sub li a.sb-indent:hover{opacity:1;color:#F2C300;}',
...
'    <span class="nav-wordmark">Flow<span class="brand-a">telligence</span></span>',
'    <span class="nav-tagline">Where workflow meets intelligence.</span>',
'  </a>',
...
'        <a href="../pages/tools.html?tab=orchestrator">Flowtelligence Orchestrator</a>',
'        <a class="dd-sub" href="../pages/see-orchestrator-in-action.html">&#8627; See Orchestrator in Action</a>',
'        <a href="../pages/tools.html?tab=enroller">Flowtelligence Enroller</a>',
'        <a class="dd-sub" href="../pages/see-it-in-action.html">&#8627; See Enroller in Action</a>',
'        <a href="../pages/tools.html?tab=pulse">Flowtelligence Pulse</a>',
...
'        <a href="../pages/tools.html?tab=engage">Flowtelligence Engage</a>',
'        <a class="dd-sub" href="../pages/my-easy-match.html">&#8627; MatchIQ</a>',
'        <a class="dd-sub" href="../pages/see-matchiq-in-action.html">&#8627; See MatchIQ in Action</a>',
'        <a class="dd-sub" href="../pages/messaging.html">&#8627; Flowtelligence Link</a>',
'        <a class="dd-sub" href="../pages/incentives.html">&#8627; Flowtelligence Spark</a>',
'        <a class="dd-sub" href="../pages/app-scanning.html">&#8627; ScanIQ</a>',
'        <a class="dd-sub" href="../pages/lead-gen.html">&#8627; Flowtelligence LeadFlow</a>',
'        <a href="../pages/tools.html?tab=launchpad">Flowtelligence Launchpad</a>',
'      </div>',
'    </li>',
'    <li id="tl-c">',
...
'        <li><a href="../pages/tools.html?tab=orchestrator">Flowtelligence Orchestrator</a></li>',
'        <li><a class="sb-indent" href="../pages/see-orchestrator-in-action.html">&#8627; See Orchestrator in Action</a></li>',
'        <li><a href="../pages/tools.html?tab=enroller">Flowtelligence Enroller</a></li>',
'        <li><a class="sb-indent" href="../pages/see-it-in-action.html">&#8627; See Enroller in Action</a></li>',
'        <li><a href="../pages/tools.html?tab=pulse">Flowtelligence Pulse</a></li>',
...
'        <li><a href="../pages/tools.html?tab=engage">Flowtelligence Engage</a></li>',
'        <li><a class="sb-indent" href="../pages/my-easy-match.html">&#8627; MatchIQ</a></li>',
'        <li><a class="sb-indent" href="../pages/see-matchiq-in-action.html">&#8627; See MatchIQ in Action</a></li>',
'        <li><a class="sb-indent" href="../pages/messaging.html">&#8627; Flowtelligence Link</a></li>',
'        <li><a class="sb-indent" href="../pages/incentives.html">&#8627; Flowtelligence Spark</a></li>',
'        <li><a class="sb-indent" href="../pages/app-scanning.html">&#8627; ScanIQ</a></li>',
'        <li><a class="sb-indent" href="../pages/lead-gen.html">&#8627; Flowtelligence LeadFlow</a></li>',
'        <li><a href="../pages/tools.html?tab=launchpad">Flowtelligence Launchpad</a></li>',
'      </ul>',
'    </li>',
'    <li>',
...
'    <li><a class="sb-link" href="../pages/contact.html" style="color:#F2C300;font-weight:700;">Contact Us</a></li>',
'  </ul>',
'</div>',
...
'    </div>',
'  </div>',
'  <div class="footer-bottom">&copy; <span id="footer-year"></span> Flowtelligence. All rights reserved.</div>',
'</footer>'
].join('\n');
